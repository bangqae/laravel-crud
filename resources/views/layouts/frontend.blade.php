      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-sm-6 col-8 header-top-left no-padding">
            <ul>
              <li><a href="{{ config('sekolah.fb_url') }}"><i class="fa fa-facebook"></i></a></li>
              <li><a href="{{ config('sekolah.tw_url') }}"><i class="fa fa-twitter"></i></a></li>
              <li><a href="{{ config('sekolah.ig_url') }}"><i class="fa fa-instagram"></i></a></li>
          ...
          <div class="col-lg-6 col-sm-6 col-4 header-top-right no-padding">
            <a href="tel:+953 012 3654 896"><span class="lnr lnr-phone-handset"></span> <span
                class="text">{{ config('sekolah.telepon') }}</span></a>
