          ...
          <div class="col-md-12">
            <div class="panel">
              ...
              <div class="panel-body">
                <form action="/siswa/{{$siswa->id}}/update" method="POST" enctype="multipart/form-data"> {{-- route --}}
                  @csrf
                  ...
                  <div class="form-group">
                      ...
                      <textarea name="alamat" class="form-control" id="" rows="2">{{$siswa->alamat}}</textarea>
                  </div>
                  <div class="form-group">
